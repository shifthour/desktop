...
const featuredProjects = [
  {
    id: 'anahata',
    slug: '/anahata-project',  // Points to static landing page
    name: 'Anahata',
    location: 'Whitefield, Bengaluru',
    fullLocation: 'Sy No. 5, Samethanahalli Village, Bengaluru, Karnataka 560067',
    image: '/assets/img/all-images/anahata-cover.jpeg',
  ...
  completed: [
    {
      ...
      name: 'Agastya',
      location: 'Bellary',
      image: '/assets/img/all-images/agastya-img3.png',
      description: 'A completed residential project in Bellary offering premium living spaces with modern amenities.',
      sqft: '1 Lakh'
    },
...
const galleryImages = [
  ...
  // Anahata Project
  { project: 'anahata', name: 'Anahata', image: '/assets/img/all-images/features-img5.png' },
...
// Home Page - Serve Anahata Project static page directly
router.get('/', (req, res) => {
  res.sendFile('anahata-project/index.html', { root: require('path').join(__dirname, '../public') });
});
