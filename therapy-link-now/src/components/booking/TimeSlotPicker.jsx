...
export default function TimeSlotPicker({
  ...
  const generateTimeSlots = (date) => {
    ...
    if (override) {
      ...
      start = override.start_time || physio.working_hours_start || "09:00";
      end = override.end_time || physio.working_hours_end || "17:00";
    } else {
      if (!(physio.available_days || []).includes(dayName)) return [];
      start = physio.working_hours_start || "09:00";
      end = physio.working_hours_end || "17:00";
    }
  ...
  const disabledDays = (date) => {
    ...
    // No override: fall back to default available_days
