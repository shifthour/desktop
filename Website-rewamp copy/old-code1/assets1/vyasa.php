        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="heading2 single-header">
                    <div class="content  w-75">
                        ...
                        <h4 class=""><img src="assets/img/icons/location1.svg" alt="">Plot no 13, opposite st.philomena's school,HLC colony road, contonment, Bellary- 583104.
</h4>
                        
                    </div>

                    <div class="btn-area1">
                        <a href="assets/img/pdf/vyasa.pdf" class="header-btn1" target="_blank">
            ...
            <div class="col-lg-6">
                <div class="img1 image-anime reveal">
                    <img src="assets/img/all-images/vyasa-img1-1.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="images-area">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/vyasa-img2.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/vyasa-img4.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="property-single-area poperty-details-pages heading2">
                    ...
                    <p>Vyasa, located in central Bellary, offers luxury and convenience with easy access to top amenities and green spaces. It balances modern living with natural surroundings, providing the best of both worlds.</p>
...
<div class="author-card text-center mb-50">
    ...
    <div class="img1 image-anime reveal pb-3">
        <img class="w-100" style="object-fit:cover" src="assets/img/all-images/vyasa-img5.png" alt="">
    </div>
    <!--<div class="img1 image-anime reveal pb-3">-->
    <!--    <img class="w-100" style="object-fit:cover" src="assets/img/all-images/single-img5.png" alt="">-->
    <!--</div>-->
    <div class="button-group">
        <a class="primary-btn3" href="gallery.php?vyasa=true">
...
<!--<img class="rounded border" src="assets/img/all-images/floor-plan-img4.png" />-->
<!--</div>-->
<!--</div>-->
                    <div class="space50 d-lg-block d-none"></div>
                    <div class="space30 d-lg-none d-block"></div>
...
<div class="space24"></div>
<div class="poperty-video-area">
<img class="rounded border" src="assets/img/all-images/map-img4.png" />
</div>
</div>
                    <div class="space50 d-lg-block d-none"></div>
                    <div class="space30 d-lg-none d-block"></div>
...
What makes Vyasa a unique residential project
</button>
</h5>
<div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Vyasa balances luxury with convenience, offering proximity to top amenities and green spaces, with modern infrastructure in the heart of Bellary city.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingTwo">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
How does Vyasa cater to community living?
</button>
</h5>
<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Vyasa fosters a sense of community with amenities like a party hall, indoor games, and landscaped gardens for social gatherings and relaxation.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingThree">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
What is the parking arrangement at Vyasa?
</button>
</h5>
<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Vyasa provides ample parking space for residents and visitors, ensuring convenience and security for all vehicles.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingFour">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">
Does Vyasa offer any customizability in apartment layouts?
</button>
</h5>
<div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Vyasa apartments come with well-planned layouts, and there may be options to personalize interiors according to residents’ preferences.</div>
</div>
</div>
</div>
</div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="slider-images-area owl-carousel">
            <div class="auhtor-boxes-area">
              <div class="img1">
                <img src="assets/img/all-images/vyasa-img1.png" alt="">
              </div>
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/vyasa-img1.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/vyasa-img2.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/vyasa-img3.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/vyasa-img4.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
  
            <div class="auhtor-boxes-area">
              <div class="img1">
                <img src="assets/img/all-images/vyasa-img5.png" alt="">
              </div>
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/vyasa-img5.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
