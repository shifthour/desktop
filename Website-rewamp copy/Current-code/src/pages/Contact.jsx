...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Grant brochure access since user has filled a form
      localStorage.setItem('brochureAccess', 'granted');

      // Build a mailto link with form data as a simple fallback
      ...
      toast.success("Thank you! Your email client has been opened. Please send the email to complete your inquiry.");
