        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="heading2 single-header">
                    <div class="content  w-75">
                        ...
                        <h4 class=""><img src="assets/img/icons/location1.svg" alt="">#1, Opp. Arunodaya Hospital, Siruguppa main Road, Ashok Nagar, Havambhavi, Ballari - 583 103.
</h4>
                        
                    </div>

                    <div class="btn-area1">
                        <a href="assets/img/pdf/Naadam.pdf" class="header-btn1" target="_blank">
            ...
            <div class="col-lg-6">
                <div class="img1 image-anime reveal">
                    <img src="assets/img/all-images/naadam-img1-1.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="images-area">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/naadam-img2.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/naadam-img3.png" alt="">
                            </div>
                        </div>

                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/naadam-img4.png" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="img1 image-anime reveal">
                                <img src="assets/img/all-images/naadam-img5.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="property-single-area poperty-details-pages heading2">
                    ...
                    <p>Naadam, near the Kumbhara Hills on Siriguppa Road, offers a peaceful lifestyle surrounded by nature. Conveniently located near top schools, hospitals, and Infantry Road's shopping and dining, it provides an elegant escape from the bustle of Ballari city.</p>
...
<div class="single-item mb-50">
    ...
    <div class="poperty-feature-wrap">
        <ul class="poperty-feature">
            ...
            <li>
                <div class="icon">
                    <img src="https://demo-egenslab.b-cdn.net/html/neckle/preview/assets/img/inner-page/icon/villa.svg"
                        alt>
                </div>
                <div class="content">
                    <h6>Yoga Hall</h6>
            ...
            <li>
                <div class="icon">
                    <img src="https://demo-egenslab.b-cdn.net/html/neckle/preview/assets/img/inner-page/icon/size.svg"
                        alt>
                </div>
                <div class="content">
            ...
            <li>
                <div class="icon">
                    <img src="https://demo-egenslab.b-cdn.net/html/neckle/preview/assets/img/inner-page/icon/build-year.svg"
                        alt>
                </div>
                <div class="content">
                    <h6>Party Hall</h6>
...
<div class="author-card text-center mb-50">
    ...
    <div class="img1 image-anime reveal pb-3">
        <img class="w-100" style="object-fit:cover" src="assets/img/all-images/naadam-img6.png" alt="">
    </div>
    <div class="img1 image-anime reveal pb-3">
        <img class="w-100" style="object-fit:cover" src="assets/img/all-images/naadam-img7.png" alt="">
    </div>
    <div class="img1 image-anime reveal pb-3">
        <img class="w-100" style="object-fit:cover" src="assets/img/all-images/naadam-img8.png" alt="">
    </div>
    <div class="button-group">
        <a class="primary-btn3" href="gallery.php?naadam=true">
...
<div class="space24"></div>
<div class="poperty-video-area">
<img class="rounded border" src="assets/img/all-images/map-img3.png" />
</div>
</div>
                    <div class="space50 d-lg-block d-none"></div>
                    <div class="space30 d-lg-none d-block"></div>
...
What types of residential units are available at Naadam?
</button>
</h5>
<div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Naadam offers a selection of spacious and thoughtfully designed apartments that cater to different family sizes and preferences.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingTwo">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
What makes Naadam's location unique?
</button>
</h5>
<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Naadam is nestled near the Kumbhara Hills, offering a serene environment while being conveniently located on Siriguppa Road, opposite Arunodaya Hospital, and accessible from major points like SP Circle and Infantry Road.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingThree">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
How is Naadam connected to key areas of Ballari?
</button>
</h5>
<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Naadam enjoys excellent connectivity to major roads, making it easy to reach important locations such as schools, hospitals, clubs, and the high-street shopping and dining area of Infantry Road.</div>
</div>
</div>
<div class="accordion-item">
<h5 class="accordion-header" id="flush-headingFour">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">
What kind of lifestyle can residents expect at Naadam?
</button>
</h5>
<div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
<div class="accordion-body">Residents at Naadam can enjoy a peaceful lifestyle away from the city's hustle, with access to nature, open spaces, and all the necessary conveniences for comfortable and elegant living.</div>
</div>
</div>
</div>
</div>
        ...
        <div class="col-lg-12">
          <div class="slider-images-area owl-carousel">
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img1.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img2.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img3.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img4.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img5.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
  
            <div class="auhtor-boxes-area">
              <div class="img1">
                <img src="assets/img/all-images/naadam-img6.png" alt="">
              </div>
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img6.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            
            <div class="auhtor-boxes-area">
              <div class="img1">
                <img src="assets/img/all-images/naadam-img7.png" alt="">
              </div>
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img7.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
            ...
            <div class="auhtor-boxes-area">
              ...
              <div class="icons">
                <a class="popup-img" href="assets/img/all-images/naadam-img8.png"><i class="fa-brands fa-plus"></i></a>
              </div>
            </div>
