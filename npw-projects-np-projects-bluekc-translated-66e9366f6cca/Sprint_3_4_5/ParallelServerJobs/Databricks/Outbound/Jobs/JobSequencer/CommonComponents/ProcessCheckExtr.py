...
# MAGIC ^1_1 11/07/06 10:32:12 Batch  14191_37938 PROMOTE bckcetl edw10 dsadm Keith for Brent
...
df_final = (
    df_Trans1
    .withColumn("SUBJ_CD", rpad(col("SUBJ_CD"), <...>, " "))
    .withColumn("TRGT_SYS_CD", rpad(col("TRGT_SYS_CD"), <...>, " "))
