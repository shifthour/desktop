...
from pyspark.sql.functions import col, upper, when, lit, rpad
# COMMAND ----------
...
df_in = (
    ...
    .csv(f"{adls_path}/verified/{FileName}")
)
...
df_final = df_xfm.select(
    rpad(col("INVC_NO").cast(StringType()), 0, " ").alias("INVC_NO"),
    rpad(col("INVC_DT").cast(StringType()), 0, " ").alias("INVC_DT"),
    ...
    rpad(col("RXCLM_NO").cast(StringType()), 0, " ").alias("RXCLM_NO"),
    rpad(col("CLM_SEQ_NO").cast(StringType()), 0, " ").alias("CLM_SEQ_NO"),
    ...
    rpad(col("NET_CLM_CT").cast(StringType()), 0, " ").alias("NET_CLM_CT"),
    rpad(col("PDX_NCPDP_ID").cast(StringType()), 0, " ").alias("PDX_NCPDP_ID"),
    rpad(col("PDX_NPI_ID").cast(StringType()), 0, " ").alias("PDX_NPI_ID"),
    rpad(col("SUBMT_PDX_ID").cast(StringType()), 0, " ").alias("SUBMT_PDX_ID"),
    rpad(col("RX_NO"), 12, " ").alias("RX_NO"),
    rpad(col("DT_RX_WRTN").cast(StringType()), 0, " ").alias("DT_RX_WRTN"),
    rpad(col("MNL_DT_SUBMSN").cast(StringType()), 0, " ").alias("MNL_DT_SUBMSN"),
    rpad(col("FILL_DT").cast(StringType()), 0, " ").alias("FILL_DT"),
    rpad(col("SUBMT_DT").cast(StringType()), 0, " ").alias("SUBMT_DT"),
    ...
    rpad(col("BRTH_DT").cast(StringType()), 0, " ").alias("BRTH_DT"),
    ...
    rpad(col("QTY_DISPNS").cast(StringType()), 0, " ").alias("QTY_DISPNS"),
    rpad(col("DAYS_SUPL").cast(StringType()), 0, " ").alias("DAYS_SUPL"),
    rpad(col("INGRS_CST").cast(StringType()), 0, " ").alias("INGRS_CST"),
    rpad(col("DISPENSE_FEE").cast(StringType()), 0, " ").alias("DISPENSE_FEE"),
    rpad(col("SLS_TAX").cast(StringType()), 0, " ").alias("SLS_TAX"),
    rpad(col("PATN_CST").cast(StringType()), 0, " ").alias("PATN_CST"),
    rpad(col("PLN_CST").cast(StringType()), 0, " ").alias("PLN_CST"),
    rpad(col("TOT_CST").cast(StringType()), 0, " ").alias("TOT_CST"),
    rpad(col("BILL_CLM_CST").cast(StringType()), 0, " ").alias("BILL_CLM_CST"),
    rpad(col("CLM_ADM_FEE").cast(StringType()), 0, " ").alias("CLM_ADM_FEE"),
    ...
    rpad(col("CLM_SK").cast(StringType()), 0, " ").alias("CLM_SK"),
    rpad(col("AWP_AMT").cast(StringType()), 0, " ").alias("AWP_AMT"),
    rpad(col("LICS_AMT").cast(StringType()), 0, " ").alias("LICS_AMT"),
    rpad(col("CGAP_AMT").cast(StringType()), 0, " ").alias("CGAP_AMT"),
    rpad(col("MI_HICA_TAX_IN"), 2, " ").alias("MI_HICA_TAX_IN"),
    rpad(col("MI_HICA_TAX_AMT").cast(StringType()), 0, " ").alias("MI_HICA_TAX_AMT"),
    rpad(col("HLTH_PLN_AMT").cast(StringType()), 0, " ").alias("HLTH_PLN_AMT"),
    rpad(col("MCARE_PLN_TYP"), 1, " ").alias("MCARE_PLN_TYP"),
    rpad(col("DUAL_EGWP_AMT").cast(StringType()), 0, " ").alias("DUAL_EGWP_AMT")
)
