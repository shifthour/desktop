...
# MAGIC BCA FEP Claim Primary Key Process
# MAGIC """
# COMMAND ----------
...
from pyspark.sql.functions import col, lit, length, substring, union_all
# COMMAND ----------
...
df_Regular = df_BCAFEPClmLanding.select(
...
df_collector = df_Regular.unionByName(df_Adjustments)

df_hf_bcafep_clmpk_dedupe = df_collector.dropDuplicates(["SRC_SYS_CD_SK", "CLM_ID"])
...
df_ClmLoadPK = ClmLoadPK(df_hf_bcafep_clmpk_dedupe, params_ClmLoadPK)

df_final = df_ClmLoadPK.select("SRC_SYS_CD", "CLM_ID", "CRT_RUN_CYC_EXCTN_SK", "CLM_SK")
