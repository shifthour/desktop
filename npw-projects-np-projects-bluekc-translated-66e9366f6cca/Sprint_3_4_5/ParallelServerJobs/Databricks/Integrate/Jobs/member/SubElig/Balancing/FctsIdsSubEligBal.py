...
# MAGIC 
# MAGIC 
# MAGIC CALLED BY:       FctsIdsSubEligBalSeq
# MAGIC 
# MAGIC PROCESSING:
...
extract_query = f"""
SELECT
SUB_ELIG.SRC_SYS_CD_SK AS SRC_SRC_SYS_CD_SK,
SUB_ELIG.SUB_UNIQ_KEY AS SRC_SUB_UNIQ_KEY,
SUB_ELIG.SUB_ELIG_CLS_PROD_CAT_CD_SK AS SRC_SUB_ELIG_CLS_PROD_CAT_CD_SK,
SUB_ELIG.EFF_DT_SK AS SRC_EFF_DT_SK,
SUB_ELIG.SEQ_DTM AS SRC_SEQ_DTM,
B_SUB_ELIG.SRC_SYS_CD_SK AS TRGT_SRC_SYS_CD_SK,
B_SUB_ELIG.SUB_UNIQ_KEY AS TRGT_SUB_UNIQ_KEY,
B_SUB_ELIG.SUB_ELIG_CLS_PROD_CAT_CD_SK AS TRGT_SUB_ELIG_CLS_PROD_CAT_CD_SK,
B_SUB_ELIG.EFF_DT_SK AS TRGT_EFF_DT_SK,
B_SUB_ELIG.SEQ_DTM AS TRGT_SEQ_DTM
FROM {IDSOwner}.SUB_ELIG SUB_ELIG
FULL OUTER JOIN {IDSOwner}.B_SUB_ELIG B_SUB_ELIG
ON SUB_ELIG.SRC_SYS_CD_SK = B_SUB_ELIG.SRC_SYS_CD_SK
AND SUB_ELIG.SUB_UNIQ_KEY = B_SUB_ELIG.SUB_UNIQ_KEY
AND SUB_ELIG.SUB_ELIG_CLS_PROD_CAT_CD_SK = B_SUB_ELIG.SUB_ELIG_CLS_PROD_CAT_CD_SK
AND SUB_ELIG.EFF_DT_SK = B_SUB_ELIG.EFF_DT_SK
AND SUB_ELIG.SEQ_DTM = B_SUB_ELIG.SEQ_DTM
WHERE SUB_ELIG.LAST_UPDT_RUN_CYC_EXCTN_SK >= {ExtrRunCycle}
"""
...
df_Research = df_Research.select(
    "TRGT_SRC_SYS_CD_SK",
    "TRGT_SUB_UNIQ_KEY",
    "TRGT_SUB_ELIG_CLS_PROD_CAT_CD_SK",
    "TRGT_EFF_DT_SK",
    "TRGT_SEQ_DTM",
    "SRC_SRC_SYS_CD_SK",
    "SRC_SUB_UNIQ_KEY",
    "SRC_SUB_ELIG_CLS_PROD_CAT_CD_SK",
    "SRC_EFF_DT_SK",
    "SRC_SEQ_DTM"
)
...
write_files(
    df_Research,
    f"{adls_path}/balancing/research/FacetsIdsSubEligResearch.dat.{RunID}",
    delimiter=",",
    mode="overwrite",
    is_parquet=False,
    header=False,
...
if ToleranceCd == 'OUT':
    df_Notify = spark.createDataFrame(
        [("ROW COUNT BALANCING FACETS - IDS SUB ELIG OUT OF TOLERANCE",)],
        ["NOTIFICATION"]
    )
