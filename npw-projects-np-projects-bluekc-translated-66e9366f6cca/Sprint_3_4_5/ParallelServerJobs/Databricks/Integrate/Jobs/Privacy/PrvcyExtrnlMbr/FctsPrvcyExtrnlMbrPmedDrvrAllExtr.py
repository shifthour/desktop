...
# MAGIC 
# MAGIC JOB NAME:  FctsPrvcyExtrnlMbrPmedDrvrAllExtr
# MAGIC CALLED BY:
# MAGIC 
# MAGIC PROCESSING:
# MAGIC 
...
# MAGIC Ralph Tucker                  2010-03-31    3556 - CDC                       Setup for ENEN and PMED seperate     IntegrateCurDevl          Brent Leland                  04/07/2010
# MAGIC                                                                                                        build then combine
...
# MAGIC Facets Privacy Extrnl Mbr PMED Driver Extract for All Records
...
extract_query = f"SELECT fhp.PMED_CKE FROM {facetsOwner}.FHP_PMED_MEMBER_D fhp, {facetsOwner}.FHD_ENEN_ENTITY_D fhd WHERE fhp.PMED_CKE = fhd.ENEN_CKE AND fhd.EXEN_REC = 0"
...
df_xfmDrvrUpd = df_xfmDrvrUpd.withColumn("OP", rpad(col("OP"), 1, " "))
