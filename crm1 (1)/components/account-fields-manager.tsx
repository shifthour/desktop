...
export function AccountFieldsManager() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      const response = await fetch('/api/admin/account-fields', {
        method: 'PUT',
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Customize which fields appear in the account creation form
          </p>
        </div>
            ...
            <TabsContent value="mandatory" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    These fields are required for all accounts and cannot be disabled
                  </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <CardDescription>
                        Toggle these fields on/off to customize your account form
                      </CardDescription>
                    </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <Select value={selectedSectionFilter} onValueChange={setSelectedSectionFilter}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="business_details">Business Details</SelectItem>
