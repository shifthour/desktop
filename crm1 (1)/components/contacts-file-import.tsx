...
interface ContactsFileImportProps {
  isOpen: boolean
  onClose: () => void
...
export function ContactsFileImport({ 
  ...
  const downloadTemplate = () => {
    // Contact fields template - matching the exact field names used in import mapping
    const headers = [
      'Account Name',       // maps to: item.accountName || item['Account Name'] || item.company
      'Contact Name',       // maps to: item.contactName || item['Contact Name'] || item.name  
      'Department',         // maps to: item.department || item.Department
      'Position',           // maps to: item.position || item.Position || item.title
      'Phone',             // maps to: item.phone || item.Phone || item['Contact Phone']
      'Email',             // maps to: item.email || item.Email || item['Email Address']
      'Website',           // maps to: item.website || item.Website || item['Website URL']
    ...
    // Sample data for contacts import
    const sampleData = [
      'IIFM,Dr. Priya Sharma,Research & Development,Research Director,+91 98765 43210,priya.sharma@iifm.edu.in,https://www.iifm.edu.in,123 Research Park Road,Mumbai,Maharashtra,Sales Rep 1',
      'IIFM,Mr. Rajesh Kumar,Laboratory,Lab Manager,+91 90123 45678,rajesh.k@iifm.edu.in,https://www.iifm.edu.in,123 Research Park Road,Mumbai,Maharashtra,Sales Rep 1', 
      'Eurofins Advinus,Ms. Anjali Menon,Quality Control,Quality Head,+91 87654 32109,anjali.menon@eurofins.com,https://www.eurofins.com,456 Tech Park Whitefield,Bangalore,Karnataka,Sales Rep 2',
      'JNCASR,Dr. Anu Rang,Research & Development,Senior Scientist,+91 91234 56789,anu.rang@jncasr.ac.in,https://www.jncasr.ac.in,789 Science Complex,Bangalore,Karnataka,Sales Rep 3',
      'Bio-Rad Laboratories,Mr. Sanjay Patel,Production,Operations Manager,+91 98876 54321,sanjay.patel@biorad.com,https://www.bio-rad.com,321 Industrial Estate,Chennai,Tamil Nadu,Sales Rep 2',
      'Guna Foods,Ms. Pauline D\'Souza,Quality Control,Quality Head,+91 95432 10987,pauline@gunafoods.com,https://www.gunafoods.com,654 Food Processing Unit,Villupuram,Tamil Nadu,Sales Rep 1'
    ]
    ...
    toast({
      ...
      description: "Use this CSV template to format your contact data"
    })
  }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Import Contacts File</DialogTitle>
        </DialogHeader>
