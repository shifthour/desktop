...
export function LeadFieldsManager() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    try {
      const response = await fetch('/api/admin/lead-fields', {
        method: 'PUT',
      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Customize which fields appear in the lead creation form
          </p>
        </div>
            ...
            <TabsContent value="mandatory" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    These fields are required for all leads and cannot be disabled
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <CardDescription>
                        Toggle these fields on/off to customize your lead form
                      </CardDescription>
                    </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <Select value={selectedSectionFilter} onValueChange={setSelectedSectionFilter}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="lead_details">Lead Details</SelectItem>
                ...
                <CardContent>
                  {optionalFields.length === 0 ? (
                    ...
                    <ScrollArea className="h-[600px] pr-4">
                      {['basic_info', 'lead_details', 'contact_info', 'additional_info']
