-- Add all missing columns to installations table
...
ALTER TABLE installations ADD CONSTRAINT IF NOT EXISTS installations_source_type_check 
    CHECK (source_type IN ('sales_order', 'invoice', 'direct'));

ALTER TABLE installations ADD CONSTRAINT IF NOT EXISTS installations_installation_type_check 
