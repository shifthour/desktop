...
class SupabaseFunctions {
  static Future<String> sendResendEmail(String toEmail, String otp) async {
    // On web, we can't send emails due to CORS, so return OTP for testing
    if (kIsWeb) {
      print('🌐 WEB MODE: OTP for $toEmail is: $otp');
      print('⚠️ In production, use a backend API or Supabase Edge Function');
      return otp; // Return OTP for web testing
    }

    // On mobile, send actual email
