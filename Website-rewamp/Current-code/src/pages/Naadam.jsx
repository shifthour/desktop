...
const highlights = [
  { icon: Building2, number: "1.42 Lakh", label: "Sqft Total Area" },
  { icon: Home, number: "2BHK & 3BHK", label: "Apartments" },
...
const amenities = [
  "Swimming Pool", "Yoga Hall", "Kids Play Area", "Gymnasium",
  "Outdoor Sitting Spaces", "Party Hall", "Landscaped Garden", "Electric Charging Points for EV",
];
...
export default function Naadam() {
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Naadam, near the Kumbhara Hills on Siriguppa Road, offers a peaceful lifestyle surrounded by nature. Conveniently located near top schools, hospitals, and Infantry Road's shopping and dining, it provides an elegant escape from the bustle of Ballari city.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-12 md:py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <p className="text-sm tracking-[0.3em] uppercase text-orange-500 mb-4 font-semibold">Why Choose Naadam</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            <div className="flex items-start gap-3 mb-4">
              ...
              <p className="text-gray-700">#1, Opp. Arunodaya Hospital, Siruguppa main Road, Ashok Nagar, Havambhavi, Ballari - 583 103</p>
            </div>
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              <div className="space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Near Kumbhara Hills</p>
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Near Arunodaya Hospital</p>
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Infantry Road Shopping & Dining</p>
              </div>
              <div className="space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> SP Circle</p>
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-light mb-4">Interested in Naadam?</h2>
