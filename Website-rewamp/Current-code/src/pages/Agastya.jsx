...
import { MapPin, Home, Building2, Trees, ArrowRight, ChevronLeft, ChevronRight, CheckCircle, Phone, Award } from 'lucide-react';
...
const highlights = [
  { icon: Building2, number: "1.10 Lakh", label: "Sqft Total Area" },
  { icon: Award, number: "Completed", label: "Project" },
  { icon: Building2, number: "2", label: "Lifts" },
  { icon: MapPin, number: "Near", label: "Metro" },
];
...
const amenities = [
  "Swimming Pool", "Children Play Area", "Outdoor Sitting Spaces", "Multipurpose Hall",
  "Gymnasium", "Walking Track", "Landscaped Garden",
];
...
export default function Agastya() {
  ...
  return (
    <div className="bg-white min-h-screen pt-24">
      <Navbar />
      <WhatsAppButton message="Hi, I'm interested in Agastya project. Can you please provide more details?" />
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Agastya offers modern architecture and luxurious amenities in a tranquil setting away from traffic and pollution. Located near Tumkur Highway, residents enjoy a swimming pool, clubhouse, yoga hall, gym, kids play area, and landscaped gardens. This property is ideal for families seeking comfort and peace.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-12 md:py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <p className="text-sm tracking-[0.3em] uppercase text-orange-500 mb-4 font-semibold">Why Choose Agastya</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md">
            <div className="flex items-start gap-3 mb-4">
              ...
              <p className="text-gray-700">No:74, 2nd Cross, Bagalagunte, Behind Kennametal, Yeshwanthpur Hobli, off Tumkur Road, 700 mts to Nagasandra Metro Station, Bangalore 560073</p>
            </div>
            <div className="grid md:grid-cols-2 gap-4 mt-6">
              <div className="space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> 700 mts to Nagasandra Metro Station</p>
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Off Tumkur Road</p>
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Near Kennametal</p>
              </div>
              <div className="space-y-2 text-sm text-gray-600">
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Away from Traffic & Pollution</p>
                <p className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-orange-500" /> Yeshwanthpur Hobli</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 text-white shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-light mb-4">Interested in Agastya?</h2>
